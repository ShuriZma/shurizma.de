...
$lang = array(
    ...
    "partner-1-p4" => "Ich kaufe nun schon seit Jahren bei Händlern auf Kinguin und hatte erst einmal ein Problem mit einem Händler, welches aber schnell durch den Kinguin-Support beseitigt wurde!",
    "partner-1-p5" => "Ebenfalls ein Grund warum ich eigentlich immer bei Kinguin kaufe.. Das Wallet :D Mit jedem Kauf bekommt man Geld.",
);
