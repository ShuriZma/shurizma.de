<head>
    <title><?php echo $lang['payday'] ?></title>
</head>
<div id="content" class="bg-white">
    <h1><?php echo $lang['payday-title'] ?></h1>
    ...
    <ul>
        <ul>
            ...
            <p><?php echo $lang['payday-build-0001-p3'] ?></p>
            <h4 class="red-link"><?php echo $lang['payday-warning-1'] ?></h4>
        </ul>
        <br>
        <ul>
            ...
            <p><?php echo $lang['payday-build-0002-p3'] ?></p>
            <h4 class="red-link"><?php echo $lang['payday-warning-2'] ?></h4>
        </ul>
    </ul>
</div>
